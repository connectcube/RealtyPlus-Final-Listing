  ...
  return (
    <AdminLayout>
      <div className="flex flex-col min-h-screen">
        <main className="flex-grow mx-auto px-4 container">
          <div className="mx-auto max-w-5xl">
            <h1 className="mb-2 font-bold text-gray-900 text-2xl sm:text-3xl">
              List Your Property
            </h1>
            <p className="mb-6 sm:mb-8 text-gray-600">
              Fill in the details below to list your property on Realty Plus
            </p>
                        ...
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-gray-500 text-sm">
                              ...
                              This address will not be displayed publicly. It
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="mb-4 text-gray-500">
                              Upload high-quality images of your property (max
                              10 images)
                            </p>
                            ...
                            {uploadedImages.length > 0 && (
                              <div className="mt-6">
                                ...
                                <p className="mb-3 text-gray-500 text-sm">
                                  ...
                                  photo. The first image will be automatically
                                  set as the cover photo if none is selected.
                                </p>
